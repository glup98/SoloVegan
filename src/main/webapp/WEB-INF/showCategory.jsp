...
<head>
    ...
    <title>Bienvenido a SoloVegan| <c:out value="${category.categoryName}"/></title>
...
<body>
    ...
    <!-- Resultados de productos por categorias -->
        <div class="app-container col mx-3 d-inline-block">
            <div class="d-flex justify-content-center row">
        <h1><c:out value="${category.categoryName}"/>:</h1> 
        <c:forEach items="${allStoreHasProductsInCategory}" var="storeHasProduct">
            <div class=" card mx-2 my-2 col-3" style="width: 18rem;">
                <div class="card-bodys">
                    ...
                    <!--<p><c:out value="${storeHasProduct.product.description}"/></p>-->
                    <c:forEach items="${storeHasProduct.product.certificates}" var="certificate">
                    <!--   <p><c:out value="${certificate.typeCertificate}"/></p>-->
                    </c:forEach>
                    <!-- Aca muestra el precio -->
